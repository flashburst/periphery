...
describe('Liquidity Gauge Pool: Exit', () => {
  ...
  it('At t0 + 9 week(s), bob exits', async () => {
    ...
    // Expected rewards + platformFee is 3,333.33 NPM
  ...
  it('At t0 + 10 week(s), charlie exits', async () => {
    ...
    // Expected rewards + platformFee is 5,666.66 NPM
    rewards.should.be.lessThanOrEqual(5666_666666666666666666n)
    rewards.should.be.greaterThan(5665_666666666666666666n)
  })
})
